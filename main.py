...
while pos[2] > 0:
    pos, heading, vel, vel_mag, accel, previous_wind_speed = simulate_flight(_mass, pos, vel, vel_mag, heading,
                                                                             applied_acceleration, _timestep,
                                                                             get_air_density, get_wind_speed)
